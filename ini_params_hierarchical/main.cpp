...
int main(int argc, char** argv)
{
    ...
    par .define<int>("sectionA.subsectionA.count", -1, "Some integer in subsection");
    par .define<int>("sectionA.subsectionA.count2", -1, "Some integer in subsection");
    par .define<int>("sectionA.subsectionA.count3", -1, "Some integer in subsection");
